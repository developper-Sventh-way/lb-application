...
export class UserRoleMySuffixComponent implements OnInit {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.userRoleService
      ...
      .subscribe({
        next: (res: HttpResponse<IUserRoleMySuffix[]>) => {
  ...
  trackId(_index: number, item: IUserRoleMySuffix): number {
    return item.id!;
  }
  ...
  protected onSuccess(data: IUserRoleMySuffix[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
    this.totalItems = Number(headers.get('X-Total-Count'));
    this.page = page;
    if (navigate) {
      this.router.navigate(['/user-role-my-suffix'], {
        queryParams: {
          page: this.page,
          size: this.itemsPerPage,
