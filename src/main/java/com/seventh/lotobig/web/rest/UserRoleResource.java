...
/**
 * REST controller for managing {@link com.seventh.lotobig.domain.UserRole}.
 */
@RestController
@RequestMapping("/api")
public class UserRoleResource {
    ...
    public ResponseEntity<List<UserRoleDTO>> getAllUserRoles(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
