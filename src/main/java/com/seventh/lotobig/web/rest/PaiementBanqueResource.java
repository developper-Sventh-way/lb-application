...
/**
 * REST controller for managing {@link com.seventh.lotobig.domain.PaiementBanque}.
 */
@RestController
@RequestMapping("/api")
public class PaiementBanqueResource {
    ...
    public PaiementBanqueResource(PaiementBanqueService paiementBanqueService, PaiementBanqueRepository paiementBanqueRepository) {
    ...
    public ResponseEntity<List<PaiementBanqueDTO>> getAllPaiementBanques(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
        log.debug("REST request to get a page of PaiementBanques");
        Page<PaiementBanqueDTO> page = paiementBanqueService.findAll(pageable);
