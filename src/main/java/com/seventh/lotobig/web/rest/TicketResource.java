...
import com.seventh.lotobig.service.TicketService;
...
/**
 * REST controller for managing {@link com.seventh.lotobig.domain.Ticket}.
 */
@RestController
@RequestMapping("/api")
public class TicketResource {
     ...
     */
    @GetMapping("/tickets")
    public ResponseEntity<List<TicketDTO>> getAllTickets(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
